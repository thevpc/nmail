...
public class ExprEvaluator {
    ...
    public <T> T evalExpr(Expr expr, Class<T> expected, ExprVars vars) {
    ...
    private <T> T getVariable(String name, Class<T> expected, ExprVars vars) {
        switch (name) {
            case "null":
                return null;
            case "true":
    ...
    public boolean checkCompare(Object a, Object b, TokenTType op) {
        switch (op) {
            ...
            case NE:
                return !checkCompare(a, b, TokenTType.EQ);
            case LT:
